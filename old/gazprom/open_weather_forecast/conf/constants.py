...
CFG_FILE_PATH_EXAMPLE = "{}/contrib/settings.yaml".format(
...
WEATHER_INFORMATION_SCHEMA = {
    "main": {"temp": float, "temp_min": float, "temp_max": float},
    "dt": int,
}
...
FORECAST_WEATHER_INFORMATION_SCHEMA = {
    "list": [
        {"main": {"temp": float, "temp_min": float, "temp_max": float}, "dt_txt": str}
    ]
}
